...
\begin{mdframed}[backgroundcolor=lgray]
	...
	The heat capacities for air are given by: $C_{V}$ = 20.78 J mol$^{\mathrm{-1}}$ K$^{\mathrm{-1}}$ and $C_{P}$ = 29.10 J mol$^{\mathrm{-1}}$ K$^{\mathrm{-1}}$.
	Assume both $C_{V}$ and $C_{P}$ are independent of temperature.
	Also assume that air can be modeled as a pure ideal gas, with a molar volume $v$ = 0.02479 m$^{\mathrm{3}}$ mol$^{\mathrm{-1}}$ at T = 298.15K and P = 1 bar.
