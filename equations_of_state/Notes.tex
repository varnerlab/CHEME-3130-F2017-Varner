...
\begin{mdframed}[backgroundcolor=lgray]
  ...
  \end{enumerate}
	...
	\begin{enumerate}
		\item[(a)]{The approximate equation of state:
		\begin{equation}
			\frac{dv}{v}=\beta dT -\kappa dP
		\end{equation}reduces to:
		\begin{equation}
			\beta dT -\kappa dP = 0
		\end{equation}at constant volume. We can rearrange the constant volume equation of state:
		\begin{equation}
			\left(\frac{dP}{dT}\right)_{v} = \frac{\beta}{\kappa}
